...
export const SectionF = () => {
  return (
    <div className="my-20 relative">
      <img src="bg-f.png" className="absolute -z-10 lg:-top-60 w-full" />
      <div className="container">
        ...
        <div className="xl:px-36 relative">
          <img
            src="bunny.png"
            className="hidden absolute w-[25%] right-0 xl:top-5 lg:block lg:bottom-0 lg:-right-10"
          />
          <div className="w-full bg-[#02314D] rounded-2xl md:flex">
            ...
            <div className="flex flex-col p-10 lg:py-20 space-y-10 lg:justify-between xl:justify-between xl:p-0 xl:pl-10 xl:my-10">
              {COMMUNITY.map((item, key) => (
                <div className="flex flex-col" key={key}>
                  <span className="text-xl lg:text-4xl font-extrabold font-[red-rose] text-[#FCDD6F]">
                    {item.name}
                  </span>
                  <span className="lg:text-xl font-bold">{item.infor}</span>
                  <a
                    href={item.link}
