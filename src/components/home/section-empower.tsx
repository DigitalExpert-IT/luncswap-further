    ...
    <div className="section-d">
      <div className="px-5 lg:px-10 xl:px-28">
        ...
        <div className="flex rounded-3xl bg-gradient-to-r from-[#184B6A] to-[#085364] relative max-h-[calc(51vh-80%)] overflow-y-visible p-5 items-center">
          ...
          />
          <div className="md:w-[0%] lg:w-[80%] xl:w-[50%] 2xl:w-[50%] hidden md:block bg-yellow-100"></div>
          <div className="z-10 space-y-20 md:space-y-0 md:flex md:space-x-20 justify-between md:items-center md:align-center lg:w-full 2xl:px-20">
            {EMPOWER.map((item, idx) => (
              <div className="flex flex-col xl:items-start md:w-40" key={idx}>
                <div>
                  <img src={item.image} />
                </div>
                <div className="flex flex-col md:w-[95%] my-5">
